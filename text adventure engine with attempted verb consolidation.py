...
# # This can and should be removed when the object-oriented method is fully implemented!!!
# edible_objects = ['schmoozle', 'rabbit']
# drinkable_objects = ['juicebox']
# flammable_objects = ['bat', 'cat']

# # Remove verb list when verb dictionary is fully implemented.
# verbs = ['take', 'drop', 'examine', 'open', 'close', 'read', 'enter', 'climb', 'attack', 'eat', 'drink', 'throw', 'activate', 'deactivate', 'move', 'burn']

synonyms = {'get': 'take', 'grab': 'take', 'pick up': 'take', 'put': 'drop', 'place': 'drop', 'enter': 'go', 'in': 'inside', 'into': 'inside', 'look at': 'examine', 'go to': 'enter', 'kill': 'attack', 'turn on': 'activate', 'turn off': 'deactivate'}
...
while not game_over:
    ...
    # Attempt at consolidating verbs
    if action in verbs:
