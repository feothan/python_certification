...
story_pages = {
    1: {
        ...
        'choices': {
            1: {'choice': "Pull the chord.", 'go_to_page': 2},
            2: {'choice': "Look at your phone.",'go_to_page': 3}
        }
    },
    2: {
        'description': "The bus driver opens the doors, but there's a dude wearing a rabbit mascot outfit in your way!",
        'choices': {
            1: {'choice': "Push the rabbit dude out of the way.", 'go_to_page': 4},
            2: {'choice': "Ask him (or her) politely to step aside.", 'go_to_page': 5},
            3: {'choice': "Try to climb out the window.", 'go_to_page': 7}
        }
    },
    3: {
